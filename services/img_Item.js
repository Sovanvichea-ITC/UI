const Images = require("../models/vendor/image/img_item");
...
const create = async (name,itemID,imageUrl,desc) => {
  //console.log(name,userID,imageUrl,desc)
  try {
    const createdImage = await Images.create({ name, itemID, imageUrl, desc });
